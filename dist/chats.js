...
function storedNewChat(chatId, chatName) {
    chats.push({
        chatId,
        name: chatName,
        messages: []
    ...
    chats.toReversed().forEach(chat => {
      ...
      <div class="chat-container ${chat.chatId === currentChatId ? 'current-chat' : ''}">
        ...
        <div class="dropdown-menu dropdown-menu-chat-id-${chat.chatId}">
          ...
          <button 
            class="drowpdown-menu-item-button can-focus" id="rename-chat-button"
          ...
          <button
            class="drowpdown-menu-item-button can-focus" id="add-to-project-button">
          ...
          <button
            class="drowpdown-menu-item-button can-focus" id="delete-chat-button"
            data-chat-id="${chat.chatId}">
...
export function storeChats() {
    localStorage.setItem('chats', JSON.stringify(chats));
}
export function renderMessages(currentChatId) {
